...
ImeResearcher::ImeResearcher()
{

}

int ImeResearcher::Match(const boost::regex &rule, const PacketInfo *pktInfo, const string &objInfo)
{ 
...
void ImeResearcher::SetResearchInfo(const PacketInfo *pktInfo, const string& objInfo)
{
	char strMac[20] = {0};
